        ...
        <div class="table-container">
            <table class="table table-hover table-bordered border-primary border">
                ...
                <tbody>
                    ...
                    $query = mysqli_query($conn, "SELECT id, name, is_active, created_on, created_by, modify_on, modify_by FROM products WHERE is_active = 1 ORDER BY id DESC LIMIT $offset, $recordsPerPage");
                    $total_records = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM products WHERE is_active = 1"));
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="products-view.php?viewId=<?php echo htmlentities($row['id']); ?>"><i class="btn btn-success">View</i></a>
                            <a href="products-edit.php?editId=<?php echo htmlentities($row['id']); ?>"><i class="btn btn-primary">Edit</i></a>
                            <a href="products-delete.php?delId=<?php echo htmlentities($row['id']); ?>" onclick="return confirm('Do you really want to Delete ?');"><i class="btn btn-danger">Delete</i></a>
                        </td>
                    </tr>
                    <?php 
                        $count++;
