            ...
            <table class="table table-hover table-bordered border-primary border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo '<img src="/ecommerce/ecommerce/uploads/'.$row['image'] . '" alt="Image" style="width:100px;height:auto;"/>'; ?></td>
                        ...
                        <td>
                            <a href="users-view.php?viewId=<?php echo htmlentities($row['id']); ?>"><i class="btn btn-success">View</i></a>
                            <a href="users-edit.php?editId=<?php echo htmlentities($row['id']); ?>"><i class="btn btn-primary">Edit</i></a>
                            <a href="users-delete.php?delId=<?php echo htmlentities($row['id']); ?>" onclick="return confirm('Do you really want to Delete ?');"><i class="btn btn-danger">Delete</i></a>
                        </td>
                    </tr>
                    <?php 
                        $count++;
